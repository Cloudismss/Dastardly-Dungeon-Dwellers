...
const short unsigned int BASE_PLAYER_MELEE_DAMAGE = 0;
const short unsigned int BASE_PLAYER_MAGIC_DAMAGE = 0;
const short unsigned int BASE_PLAYER_RANGED_DAMAGE = 5;
